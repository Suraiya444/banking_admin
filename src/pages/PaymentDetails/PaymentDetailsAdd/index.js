...
function paymentDetailAdd() {
    const [inputs, setInputs] = useState({id:'',customer_id:'',customer_account_id:'',payment_date:'',payment_type_id:'',amount:''});
...
export default paymentDetailAdd;