...
function BankBranchAdd() {
    const [inputs, setInputs] = useState({id:'',bank_id:'',name:'',contact_no:'',email:'',address:''});
    ...
    function getDatas(){
        axios.get(`${process.env.REACT_APP_API_URL}/bank_branch/${id}`,config).then(function(response) {
