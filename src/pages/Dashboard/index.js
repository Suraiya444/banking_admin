                  ...
                  <div className="card">
                      ...
                      <div className="comment-widgets scrollable">
                          ...
                          <div className="d-flex flex-row comment-row m-t-0">
                              <div className="p-2"><img src="./assets_admin/assets/images/users/1.jpg" alt="user" width="50" className="rounded-circle"/></div>
                          ...
                          <div className="d-flex flex-row comment-row">
                              <div className="p-2"><img src="./assets_admin/assets/images/users/4.jpg" alt="user" width="50" className="rounded-circle"/></div>
                          ...
                          <div className="d-flex flex-row comment-row">
                              <div className="p-2"><img src="./assets_admin/assets/images/users/5.jpg" alt="user" width="50" className="rounded-circle"/></div>
                              <div className="comment-text w-100">
                              ...
                              <ul className="list-task todo-list list-group m-b-0" data-role="tasklist">
                                  <li className="list-group-item todo-item" data-role="task">
                                      ...
                                      <ul className="list-style-none assignedto">
                                          <li className="assignee"><img className="rounded-circle" width="40" src="./assets_admin/assets/images/users/1.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave"/></li>
                                          <li className="assignee"><img className="rounded-circle" width="40" src="./assets_admin/assets/images/users/2.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica"/></li>
                                          <li className="assignee"><img className="rounded-circle" width="40" src="./assets_admin/assets/images/users/3.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"/></li>
                                          <li className="assignee"><img className="rounded-circle" width="40" src="./assets_admin/assets/images/users/4.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"/></li>
                                      </ul>
                                  </li>
                                  <li className="list-group-item todo-item" data-role="task">
                                      <div className="custom-control custom-checkbox">
                   ...
                   <div className="col-lg-6">
                               ...
                               <div className="chat-box scrollable" style={{height: '475px'}}>
                                   ...
                                   <ul className="chat-list">
                                       ...
                                       <li className="chat-item">
                                           <div className="chat-img"><img src="./assets_admin/assets/images/users/1.jpg" alt="user"/></div>
                                       ...
                                       <li className="chat-item">
                                           <div className="chat-img"><img src="./assets_admin/assets/images/users/2.jpg" alt="user"/></div>
                                           <div className="chat-content">
                                       ...
                                       <li className="chat-item">
                                           <div className="chat-img"><img src="./assets_admin/assets/images/users/3.jpg" alt="user"/></div>
                                           <div className="chat-content">
                               ...
                               <div className="row">
                                   <div className="col-9">
                                       <div className="input-field m-t-0 m-b-0">
                                           <textarea id="textarea1" placeholder="Type and enter" className="form-control border-0"></textarea>
                                       </div>
                                   </div>
                                   <div className="col-3">
                                       <a className="btn-circle btn-lg btn-cyan float-right text-white" href="javascript:void(0)"><i className="fas fa-paper-plane"></i></a>
                                   </div>
                               </div>
                           </div>
                       </div>
                               ...
                               <div className="card-header" id="headingOne">
                                 <h5 className="mb-0">
                                   <a data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                       <i className="m-r-5 fa fa-magnet" aria-hidden="true"></i>
                       ...
                       <div id="accordian-4">
                           <div className="card m-t-30">
                               <a className="card-header link" data-toggle="collapse" data-parent="#accordian-4" href="#Toggle-1" aria-expanded="true" aria-controls="Toggle-1">
                                   <i className="seticon fa fa-arrow-right" aria-hidden="true"></i>
                               ...
                               <a className="card-header link border-top" data-toggle="collapse" data-parent="#accordian-4" href="#Toggle-2" aria-expanded="false" aria-controls="Toggle-2">
                                   <i className="seticon fa fa-times" aria-hidden="true"></i>
                       ...
                       <div className="card">
                           ...
                           <ul className="nav nav-tabs" role="tablist">
                               <li className="nav-item"> <a className="nav-link active" data-toggle="tab" href="#home" role="tab"><span className="hidden-sm-up"></span> <span className="hidden-xs-down">Tab1</span></a> </li>
                           ...
                           <div className="tab-content tabcontent-border">
                               <div className="tab-pane active" id="home" role="tabpanel">
                                   <div className="p-20">
                                       ...
                                       <img src="./assets_admin/assets/images/background/img4.jpg" className="img-fluid"/>
                                   </div>
                               </div>
